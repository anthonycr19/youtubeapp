// To parse this data:
//
//   import { Convert, YouTuveResponse } from "./file";
//
//   const youTuveResponse = Convert.toYouTuveResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface YouTuveResponse {
    kind:          string;
    etag:          string;
...
export class Convert {
    public static toYouTuveResponse(json: string): YouTuveResponse {
        return cast(JSON.parse(json), r("YouTuveResponse"));
    }

    public static youTuveResponseToJson(value: YouTuveResponse): string {
        return JSON.stringify(uncast(value, r("YouTuveResponse")), null, 2);
    }
}
